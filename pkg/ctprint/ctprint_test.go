...
var ctbytesTestCases = []struct {
	...
	},
	{
		...
		Print: " CT: orig=tcp:2001:470:b750:1:2423:1275:314c:6e67:50193->2a07:5741:0:1178::1:22, reply=tcp:2a07:5741:0:1178::1:22->2001:470:b750:1:2423:1275:314c:6e67:50193, AttrTCPState=[3], timeout=300s, id=0xe232ecc9, status=SEEN_REPLY,ASSURED,CONFIRMED, AttrTCPFlagsOrig=[35 0], AttrTCPFlagsRepl=[51 0], AttrTCPWScaleOrig=[6], AttrTCPWScaleRepl=[7]",
		Mark:  0,
	...
	},
	{
		...
		Print: " CT: orig=tcp:10.202.101.63:55544->10.111.10.138:27017, reply=tcp:10.111.10.138:27017->10.202.101.63:55544, AttrTCPState=[1], timeout=120s, id=0xc93dfacf, status=CONFIRMED,SRC_NAT_DONE,DST_NAT_DONE, AttrTCPFlagsOrig=[3 0], AttrTCPFlagsRepl=[0 0], AttrTCPWScaleOrig=[7], AttrTCPWScaleRepl=[0]",
		Mark:  0,
	...
	},
	{
		...
		Print: " CT: orig=tcp:10.111.63.1:60596->10.111.63.2:27017, reply=tcp:10.111.63.2:27017->10.111.63.1:60596, AttrTCPState=[3], timeout=300s, id=0xfc98b922, status=SEEN_REPLY,ASSURED,CONFIRMED,SRC_NAT_DONE,DST_NAT_DONE, AttrTCPFlagsOrig=[51 0], AttrTCPFlagsRepl=[35 0], AttrTCPWScaleOrig=[7], AttrTCPWScaleRepl=[7]",
		Mark:  0,
	...
	},
	{
		...
		Print: " CT: orig=icmp:0/0/44065:185.205.209.160->1.1.1.1, reply=icmp:0/0/44065:1.1.1.1->185.205.209.160, timeout=30s, id=0xc66a68b1, status=SEEN_REPLY,CONFIRMED,SRC_NAT_DONE,DST_NAT_DONE",
		Mark:  0,
	...
	},
	{
		...
		Print: " CT: orig=icmpv6:0/28260:2a07:5741:0:1178::1->2606:4700:4700::1111, reply=icmpv6:0/28260:2606:4700:4700::1111->2a07:5741:0:1178::1, timeout=30s, id=0xd09b5af4, status=SEEN_REPLY,CONFIRMED",
		Mark:  0,
