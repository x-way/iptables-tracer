...
func TestFormatPacketICMPv6(t *testing.T) {
	req_pkt := gopacket.NewPacket([]byte{0x60, 0x02, 0x5b, 0xd9, 0x00, 0x10, 0x3a, 0xff, 0x2a, 0x01, 0x02, 0xa8, 0x85, 0x02, 0x1f, 0x01, 0x45, 0x38, 0x31, 0x33, 0x04, 0x0f, 0x0a, 0x2a, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x4a, 0x26, 0xb2, 0x81, 0x00, 0x00, 0x5b, 0xe8, 0x90, 0x95, 0x00, 0x02, 0x1b, 0x3c}, layers.LayerTypeIPv6, gopacket.Default)
	rep_pkt := gopacket.NewPacket([]byte{0x64, 0x80, 0x00, 0x00, 0x00, 0x10, 0x3a, 0x2b, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2a, 0x01, 0x02, 0xa8, 0x85, 0x02, 0x1f, 0x01, 0x45, 0x38, 0x31, 0x33, 0x04, 0x0f, 0x0a, 0x2a, 0x81, 0x00, 0x49, 0x26, 0xb2, 0x81, 0x00, 0x00, 0x5b, 0xe8, 0x90, 0x95, 0x00, 0x02, 0x1b, 0x3c}, layers.LayerTypeIPv6, gopacket.Default)
	tables := []struct {
		...
		{&req_pkt, &layers.ICMPv6{TypeCode: layers.ICMPv6TypeEchoRequest<<8}, "test-src", "test-dst", 1234, "test-src > test-dst: ICMP6 echo request, id 45697, seq 0, length 1234"},
		{&rep_pkt, &layers.ICMPv6{TypeCode: layers.ICMPv6TypeEchoReply<<8}, "test-src", "test-dst", 1234, "test-src > test-dst: ICMP6 echo reply, id 45697, seq 0, length 1234"},
	}
